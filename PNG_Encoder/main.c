/*	CS 241 Honors Project (Fall 2016)
	...
	Ask Anton
	Main function which handles all "UI" and calls appropriate "modules"
*/
...
// declaration of functions from other modules, later will be made into #include "<module>.h"
...
//printf ("Size of metadata is %i", sizeof (secretMeta));
